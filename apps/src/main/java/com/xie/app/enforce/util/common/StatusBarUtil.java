 ...
 * https://github.com/scwang90/SmartRefreshLayout/blob/master/app/src/main/java/com/scwang/refreshlayout/util/StatusBarUtil.java
 */
...
public class StatusBarUtil {
     ...
     * 设置状态栏darkMode,字体颜色及icon变黑(目前支持MIUI6以上,Flyme4以上,Android M以上)
     */
    private static void darkMode(Window window, int color, @FloatRange(from = 0.0, to = 1.0) float alpha) {
        if (isFlyme4Later()) {
